<?php 
session_start();
//verouiller l'accès a notre interfaces
if(empty($_SESSION)){
...
<header>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="home.php">Gestion Commandes</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        ...
        <ul class="navbar-nav">
          <li class="nav-item nav-link">
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person" viewBox="0 0 16 16" style="color:blue;">
